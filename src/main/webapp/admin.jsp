...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="admin"></iframe>
	</div>
</div>
</section>
...
<script type="text/javascript" src="${path}resources/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="${path}resources/static/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="${path}resources/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
